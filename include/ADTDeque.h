...
// Προσθέτει την τιμή value στο _τέλος_ του deque deque. Το μέγεθος του deque μεγαλώνει κατά 1.
// Αν δεν υπάρχει διαθέσιμη μνήμη το deque παραμένει όπως ήταν (αυτό μπορεί να ελεγχθεί με τη deque_size)
